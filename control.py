...
loads = [
    {'name': 'boiler1', 'gpioPin': 17, 'power': 2, 'daily_consumption': 16, 'hrStart2': 18, 'consumption2': 7},
    {'name': 'boiler2', 'gpioPin': 27, 'power': 2, 'daily_consumption': 16, 'hrStart2': 18, 'consumption2': 7}
]
# in shell:
